//** Edited by: Mike T on March 13th 2014 - modified to include onSortComplete event, line:178
...
(function() {
    ...
    Tablesort.prototype = {
            ...
            var onClick = function(e) {
                ...
                for (var i = 0; i < siblings.length; i++) {
                    if (hasClass(siblings[i], 'sort-up') || hasClass(siblings[i], 'sort-down')) {
                        if (siblings[i] !== this) {
                            siblings[i].className = siblings[i].className.replace(' sort-up', '')
                                .replace(' sort-down', '');
                        }
                    }
                }
        ...
        sortTable: function(header, update) {
            ...
            // $('body').trigger('sortComplete'); //added by Mike T, March 2014

            var evt= new CustomEvent("sortComplete");
